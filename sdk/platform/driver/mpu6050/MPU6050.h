//MPU6050 I2C library for DAS14580 - Main header file 
//Has bit, byte and buffer I2C R/W functions
/* ============================================================================================
MPU6050 device I2C library code for DAS14580
================================================================================================
*/
...
#define MPU6050_RA_CHIP_ID          0x75
...
#define MPU6050_GYRO_FS_250         0x00   // per 131  = 1 degree/second
#define MPU6050_GYRO_FS_500         0x01   // per 63.5 = 1degree/second
#define MPU6050_GYRO_FS_1000        0x02   // per 32.8 = 1 degree/second
#define MPU6050_GYRO_FS_2000        0x03   // per 16.4 = 1 degree/second
...
#define MPU6050_ACCEL_FS_2          0x00  // +/-2g , per 16384 = 1g
#define MPU6050_ACCEL_FS_4          0x01  // +/-4g , per 8192 =  1g
#define MPU6050_ACCEL_FS_8          0x02  // +/-8g , per 4096 =  1g
#define MPU6050_ACCEL_FS_16         0x03  // +/-16g, per 2048 =  1g
...
#define MPU6050_RA_CHIP_ID_BIT        6
#define MPU6050_RA_CHIPD_ID_LENGTH     6
...
void MPU6050_printf(char *string,uint16_t number);
